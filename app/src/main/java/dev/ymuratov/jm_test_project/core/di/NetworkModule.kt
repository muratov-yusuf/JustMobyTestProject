...
import dev.ymuratov.jm_test_project.core.data.network.interceptor.ApiKeyInterceptor
...
object NetworkModule {
    ...
    fun provideOkHttpClient(
        ...
        return OkHttpClient.Builder().addInterceptor(apiKeyInterceptor).addInterceptor(networkInterceptor)
            .addInterceptor(loggingInterceptor).connectTimeout(OK_HTTP_TIMEOUT, TimeUnit.SECONDS)
